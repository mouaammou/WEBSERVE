...
#    Updated: 2024/01/12 10:57:21 by mouaammo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
RES_FILES 	= $(addprefix Response/src/, AutoIndex.cpp CGI.cpp Config.cpp  Codes.cpp MediaTypes.cpp  ParseCGIOutput.cpp  PipeStream.cpp  Response.cpp  SendResponse.cpp Execute.cpp UploadFiles.cpp)
RES_HEADERS = $(addprefix Response/include/, AutoIndex.hpp CGI.hpp Config.hpp  Codes.hpp  MediaTypes.hpp  ParseCGIOutput.hpp  PipeStream.hpp  Response.hpp  SendResponse.hpp Execute.hpp UploadFiles.hpp)
